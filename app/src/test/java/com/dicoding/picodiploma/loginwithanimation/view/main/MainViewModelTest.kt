...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.createPager(dummyUserModel.token)).thenReturn(expectedStory)

        val actualStory: PagingData<ListStoryItem> = mainViewModel.fetchStories().getOrAwaitValue()
